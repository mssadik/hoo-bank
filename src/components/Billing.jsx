    ...
    return (
        <section id="product" className={layout.sectionReverse}>
            ...
            <div className={layout.sectionInfo}>
                ...
                <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Elit enim sed massa etiam. Mauris eu adipiscing ultrices ametodio anean neque. Fusec ipsum orci rhoncus aliporttitor interger platea placeat.</p>
