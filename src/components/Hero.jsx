...
const Hero = () => {
    return (
        <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY} `}>
            ...
            <div className='absolute rounded-full z-[1] w-[80%] h-[80%] bottom-40 white__gradient pink__gradient'> </div>
            <div className='absolute z-[0] w-[50%] h-[50%] right-20 bottom-20 blue__gradient pink_gradient'> </div>
